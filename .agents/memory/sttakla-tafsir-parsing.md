...
**How to apply:** Strip source navigation centrally during parsing, recognize compact Arabic subsection labels such as `ع21، 22:` and `ع23:`, prefer dedicated range rows over chapter bodies, ignore inline cross-references as section headers, strip leading quoted Bible passages, do not infer verse 1 availability from a chapter wrapper row, and never reuse a preceding section or unmarked tail across an explicit verse gap.
