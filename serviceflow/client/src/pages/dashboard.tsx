...
import { AccountComplaintsReport } from "@/components/AccountComplaintsReport";
...
import { LoopLengthScatterReport } from "@/components/LoopLengthScatterReport";
...
const REPORT_GROUPS: { label: string; icon: React.ElementType; items: { id: ReportTab; label: string }[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "major-faults-selected",  label: "الأعطال الجسيمة المختارة" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "account-complaints", label: "شكاوى الخطوط التى لها أكونت" },
      ...
      { id: "loop-length-scatter", label: "طول الخط والسرعة والاسكور (رسم بيانى)" },
        ...
        {(user.role === ROLES.ADMIN || user.role === ROLES.DATA_MANAGER || user.role === ROLES.TECH || user.role === ROLES.EXTERNAL || user.role === ROLES.SALES_ADMIN) && adminTab === "reports" && (
          <div className="flex flex-col lg:flex-row gap-3 lg:gap-5" dir="rtl">
            ...
            <div className="flex-1 min-w-0">
              ...
              {reportTab === "major-faults-selected" && <MajorFaultsReport selectedOnly />}
              ...
              {reportTab === "account-complaints" && <AccountComplaintsReport />}
              ...
              {reportTab === "loop-length-scatter" && <LoopLengthScatterReport />}
