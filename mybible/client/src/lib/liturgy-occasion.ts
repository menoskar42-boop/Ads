...
export function detectOccasion(date: Date): OccasionTag {
  ...
  if (diff >= 50) {                                                   // ما بعد العنصرة
    ...
    /* صوم الرسل: من اليوم التالي للعنصرة لحد ٤ أبيب (وعيد الرسل ٥ أبيب).
     *
     * ⚠️ الشرط اللي كان هنا — `!(cm === 11 && cd >= 5)` — كان بيستثني
     * أبيب من ٥ وبس، فكل يوم بعد العنصرة لآخر السنة كان بيرجع «صوم
     * الرسل»: مسرى ونسيء وتوت وبابة وهاتور وكيهك. يعني الشاشة كانت
     * بتقول «صوم الرسل» في عيد الصليب وصوم العذراء وطول شهر كيهك،
     * وبتاخد مرداتهم وألحانهم غلط.
     *
     * العنصرة بتقع في بشنس (٩) أو بؤونة (١٠)، وعيد الرسل ٥ أبيب (١١) —
     * فالنافذة الحقيقية هي التلات شهور دول بس. */
    if (cm === 9 || cm === 10 || (cm === 11 && cd <= 4)) return 'apostles-fast';
  }
