...
// ── مصدر التفاسير (للمطوّرين — مش معروض في الواجهة) ─────────────────────────
//
// نصوص التفسير في client/public/tafsir-parts/ هي تفسير **أبونا أنطونيوس فكري**.
//
// 🚫 المالك قرر إن الاسم **ما يظهرش** في الموقع (قرار ٢٠٢٦-٠٨-٠٩). متضيفهوش
//    في الواجهة تاني من غير ما تسأله.
//
// وعشان الخلط ما يتكرّرش: ملفات `tafsir-links.md` و`tafsir-luke.md`
// و`tafsir-data.ts` بتشاور على تفسير **القمص تادرس يعقوب ملطي** من موقع
// القديس تكلا — ده مصدر تاني مختلف تماماً، ومش مستخدَم في التطبيق. ماتنسبش
// محتوى الـCSV له.
