...
const SEED_LEADS = [
  ...
  { name: 'R&T women accessories', phone: '01066164830', business_name: 'R&T — إكسسوارات هاند ميد', category: 'إكسسوارات', link: 'instagram.com/r.and.t.women.acc', source: 'فيسبوك — إكستنشن', status: 'new', notes: '✅ مؤكّد. مجوهرات نحاس وأحجار طبيعية، جاليري المعادي، ~90k متابع ونشطة جداً. مفيش موقع (مؤكّد). الأسعار في الكومنتات يدوي.' },
  ...
  { name: 'lolo.fashion.eg', phone: '01070077877', business_name: 'Lolo Fashion — ملابس حريمي', category: 'ملابس', link: 'instagram.com/lolo.fashion.eg', source: 'إنستجرام — إكستنشن', status: 'new', notes: '⚠️ يحتاج تأكيد. ملابس حريمي، المهندسين. الاسم شائع — أكّد الحساب الصح.' },
