...
const GUARDED = [
  ...
  ['/plans', 'clinical'],
  // الرسايل جوّاها أسئلة طبية بأسماء أصحابها — على صلاحية التحاليل
  // والخطة، مش على صلاحية «بيرد على التليفون».
  ['/messages', 'clinical'],
  // القالب العلاجي هو خطة محفوظة — نفس صلاحية الخطة بالظبط، عشان اللي
  // مايقدرش يكتب خطة مايقدرش يمسح القالب اللي الخطط بتتبني منه.
  ['/templates', 'clinical'],
  // تصدير كل العملاء بقياساتهم وتحاليلهم — السجل الطبي كله في ملف. والراوت
  // نفسه كمان بيقفله على صاحب العيادة.
  ['/export', 'clinical'],
  ['/foods', 'settings'],
  ['/settings', 'settings'],
  ['/staff', 'staff'],
