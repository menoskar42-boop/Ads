...
const ORG = {
  ...
  // ⛔ **مفيش شارع ولا رقم بريدي هنا** — قرار المالك.
  //
  // مقر الشركة هو سكنه، وكان منشور بالكامل على `/company-facts` وفي
  // سكيمة الـOrganization على **كل صفحة** في الموقع. الشغل كله أونلاين،
  // فالعنوان بالشارع ما كانش بيخدم زائر — وكان بيدّي عنوان بيت لأي حد.
  //
  // المحافظة والدولة باقيين: دول بيخدموا السيو المحلّي («في مصر»،
  // «أسيوط») ومابيدلّوش على مكان سكن. و`PostalAddress` من غير
  // `streetAddress` صالحة عند Schema.org.
  //
  // ⚠️ لو حبيت ترجّعه يوماً، رجّعه هنا **بس** — كل الصفحات بتقرا من هنا.
