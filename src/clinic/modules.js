...
const MODULES = [
  ...
  { key: 'growth',     label: 'عودة المرضى',    icon: '📈', path: '/clinic/growth',     desc: 'المرضى اللي زارونا وما رجعوش — قائمة متابعة بضغطة واتساب، مع تسجيل مين اتواصلنا معاه عشان ما نكرّرش.' },
];
