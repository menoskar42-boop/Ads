...
**اتنفّذ ورُفِع (13 مرحلة):** 1 بحث · 2 فلترة/ترتيب · 3 صور+زوم · 4 تقييمات (+AggregateRating) ·
5 مقترحات · 6 مفضّلة · 7 شوهدت مؤخراً · 8 متغيّرات · 9 مقارنة · 10 عروض+عدّاد ·
11 كوبونات · 12 شحن بالمحافظة · 21 تحكّم الأدمن في المميزات (feature flags).
كلها متحقّقة على Postgres حقيقي + دورة شراء (deal→coupon→shipping) مختبرة، وكل ميزة ليها سويتش.

**الباقي (11 أمازون + 10 منافسين):** 13,14,15,16,17,18,19,20,22,23 + 24→33.
