...
**اتنفّذ ورُفِع + متحقّق على Postgres حقيقي (26 مرحلة):**
...
21 تحكّم الأدمن في المميزات (feature flags) · 22 تقارير مبيعات · 24 Pixel+Feed ·
**27 طلب عبر واتساب** · 28 استيراد CSV · **31 بطاقات هدايا/محفظة**.
دورة الشراء الكاملة (deal→coupon→points→wallet→shipping→total + earning) مختبرة رقمياً، وكل ميزة ليها سويتش.

**الباقي (7 مراحل — أغلبها تكاملات خارجية كبيرة تحتاج مفاتيح/حسابات):**
