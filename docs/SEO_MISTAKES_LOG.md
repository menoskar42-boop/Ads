...
| 20 | **صفحة `/contact` كانت شايلة سكربت AdSense على 87 كلمة.** مفيش وحدة إعلان ظاهرة، بس اللودر لوحده بيخلّي **Auto Ads** تقدر تحطّ إعلان — يعني إعلان على صفحة فورم. | `showAds = false` **من الراوت** مش من الـview بس (الـview ممكن حد يرجّع فيها الوحدة). الصفحة فضلت مفهرَسة. |
| 21 | **٥ مقالات كانت بين 226 و298 كلمة** — تحت خط المحتوى الرقيق اللي AdSense بترفض بسببه. | اتوسّعوا لمحتوى قايم بذاته، واتزرع فحص آلي بيفشل على أي مقال تحت 300 كلمة. |
| 22 | **مفيش فاحص للموقع الرئيسي أصلاً.** `render-clinic-pages.js` كان بيمسك صفحات المستأجرين بس، فعنوان طويل أو h1 مكرّر على `/about` أو `/blog` كان هيعدّي. | `scripts/seo-audit.js` — بيعرض كل صفحة عامة ويفشل على العنوان/الوصف/الـh1/تسلسل الهيدنجز/canonical/alt/الإعلانات على المحتوى القليل. شغّله بعد أي تعديل SEO. |
