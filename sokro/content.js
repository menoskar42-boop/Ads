...
const PAGES = [
  {
    ...
    desc: 'خلّي وكيل ذكاء اصطناعي عربي يعمل بحث سوق سريع: يجمع أسعار ومنتجات ومصادر من الويب، ويطلّعلك تقرير Excel أو PDF منظّم وجاهز للتنزيل، بمصادر كل رقم جنبه.',
  ...
  },
  {
    ...
    desc: 'قول طلبك بصوتك، و Sokro يفهمه، يخطّط الخطوات، وينفّذ — يطلّعلك تقرير أو صورة أو ملخّص جاهز. إدخال صوتي بالعربي المصري، ومخرجات تنزّلها وتستخدمها على طول.',
