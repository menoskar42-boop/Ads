...
async function summarize(ctx, goal, results) {
  const sys = "Summarize the outcome for the user in 1-3 short sentences, in the user's language (Arabic if the goal is Arabic). Be concrete about what was done.";
